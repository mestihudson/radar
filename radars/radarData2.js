...
document.title = "Radar de Práticas e Ferramentas de Teste das CLT's da SUPDE";


//This is the concentic circles that want on your radar
var radar_arcs = [
                   {'r':100,'name':'Em Uso'}
                  ,{'r':200,'name':'Em Análise'}
                  ,{'r':300,'name':'Avaliaremos (Futuramente)'}
...
var radar_data = [
    { "quadrant": "Q1 - Unitários e de Componentes",
        "left" : 45,
        "top" : 18,
        "color" : "#8FA227",
        "items" : [
...
//            {"name":"Coding architects", "pc":{"r":90,"t":170},"movement":"c"}
    {"name":"Testes de Unidade para dot.net (Nunit)", "pc":{"r":130,"t":150},"movement":"t", "url":"http://www.google.com"},
    {"name":"Revisão dos Testes unitários pelo analista de testes", "pc":{"r":80,"t":100},"movement":"t"},
    {"name":"Testes de Mutação", "pc":{"r":80,"t":150},"movement":"t"},
    {"name":"Testes Unitários", "pc":{"r":80,"t":130},"movement":"t"},
    {"name":"TDD, BDD  com Cucumber", "pc":{"r":90,"t":170},"movement":"t"}


    //{"name":"Testes de Unidade para dot.net (Nunit)", "pc":{"r":230,"t":150},"movement":"t", "url":"http://www.google.com"}//,

		// {"name":"Testes de Unidade para dot.net (Nunit)", "pc":{"r":330,"t":150},"movement":"t", "url":"http://www.google.com"}
    ...
    { "quadrant": "Q2 - Funcionais (Manuais ou Automatizados) e de Histórias",
        "left": w-1000+30,
        "top" : 18,
        "color" : "#587486",
        "items" : [
...
//		{ name: 'Subversion',    pc: { r: 330, t: 18 },    movement: 'c' }
		...
		{ name: '100% de cobertura de casos de testes automatizados;', pc: { r: 170, t: 19 }, movement: 't' },
		{ name: 'Adotar Ambiente exclusivo para execução dos testes automatizados, ou seja, diferente da execução manual.',    pc: { r: 150, t: 69 },    movement: 't' },
		{ name: 'Appium',    pc: { r: 110, t: 70 },    movement: 't',    domain: 'mobile, front-end' },
		{ name: 'Autolt Jubula',    pc: { r: 180, t: 66 },    movement: 't',    domain: 'mobile, dev' },
		{ name: 'Automatizar geração de massa de dados (para permitir uma maior cobertura dos cenários de testes) ',    pc: { r: 150, t: 14 },    movement: 't' },
		{ name: 'Publicar builds da aplicação nos ambientes de teste e de validação pelo analista de testes',    pc: { r: 180, t: 55 },    movement: 't',    domain: '' },
		{ name: 'BDD',    pc: { r: 120, t: 14 },    movement: 't',    domain: '' },
		{ name: 'Critérios de aceitação como casos de testes',    pc: { r: 160, t: 60 },    movement: 't',    domain: 'front-end' },
		{ name: 'Construir ferramenta própria para automação de Testes (concorrente ao D-Behave)',    pc: { r: 180, t: 5 },    movement: 't',    domain: 'mobile' },
		{ name: 'SPI (Sistema de Povoamento de Dados Integrados) – substitui o Homologa',    pc: { r: 170, t: 29 },    movement: 't' },
		{ name: 'Dbehave',    pc: { r: 180, t: 82 },    movement: 't' },
		{ name: 'DBehave (Webservice)',    pc: { r: 180, t: 46 },    movement: 't' },
		{ name: 'Escrever os scripts de testes diretamente no Dbehave (linguagem Gherkin)',    pc: { r: 170, t: 84 },    movement: 't',    domain: 'back-end' },
		{ name: 'Execução  dos testes automatizados através da Integração Contínua  (agendada no pipeline)',    pc: { r: 180, t: 77 },    movement: 't' },
		{ name: 'Testes Automatizados com Firebug',    pc: { r: 160, t: 82 },    movement: 't' },
		{ name: 'Jenkins',    pc: { r: 150, t: 36 },    movement: 't' },
		{ name: 'Mantis',    pc: { r: 130, t: 73 },    movement: 't' },

		{ name: 'Metas de 100% de cobertura de teste automatizado',    pc: { r: 280, t: 74 },    movement: 't' },
		{ name: 'Rational XDE Tester (Automação Mainframe)',    pc: { r: 280, t: 78 },    movement: 't' },
		{ name: 'Revisão por pares de Testes e artefatos de Testes (manuais e automatizados)',    pc: { r: 260, t: 75 },    movement: 't' },
		{ name: 'Gestão dos Testes – RQM',    pc: { r: 260, t: 48 },    movement: 't' },
		{ name: 'Automação de Testes com Selenium puro', pc: { r: 280, t: 51 }, movement: 't' },
		{ name: 'Uso do Sikuli em situações onde o Dbehave com Selenium não resolve',    pc: { r: 280, t: 25 },    movement: 't' },
		{ name: 'Soap UI  (Webservice)',    pc: { r: 210, t: 31 },    movement: 't' },
		{ name: 'Testes Automatizados em DW com o TestDW',    pc: { r: 80, t: 56 },    movement: 't' },
		{ name: 'Testes Funcionais Manuais',    pc: { r: 12, t: 25 },    movement: 't',    domain: 'back-end' },
		{ name: 'Testes Funcionais Automatizados',    pc: { r: 30, t: 72 },    movement: 't',    domain: 'back-end' },
		{ name: 'Testes de Regressão',    pc: { r: 80, t: 76 },    movement: 't' },
		{ name: 'Testes em Plataforma Alta: Ambiente isolado/independente para a execução dos testes',    pc: { r: 80, t: 46 },    movement: 't' },
		{ name: 'Testes de Aplicações Desktop com TestFX',    pc: { r: 360, t: 82 },    movement: 't' },
		{ name: 'XPath Checker',    pc: { r: 380, t: 56 },    movement: 't' },
		{ name: 'TestKase',    pc: { r: 330, t: 5 },    movement: 't' },
		{ name: 'Testes Automatizados com Node.js',    pc: { r: 330, t: 18 },    movement: 't' }


  ]
    },
    { "quadrant": "Q3 - Exploratórios, de Aceitação e Usabilidade",
        "left" :45,
         "top" : (h/2 + 18),
        "color" : "#DC6F1D",
        "items" : [
...
//            {"name":"RHEL 5", "pc":{"r":370,"t":195},"movement":"c"},
            ...
            {"name":"Casos de teste com Mapas Mentais", "pc":{"r":50,"t":257},"movement":"t"},
            {"name":"Testes de Usabilidade com Firebug", "pc":{"r":130,"t":260},"movement":"t"},
            {"name":"Testes de Usabilidade", "pc":{"r":220,"t":255},"movement":"t"},
            {"name":"Testes exploratórios", "pc":{"r":390,"t":190},"movement":"t"},
            {"name":"Testes de Integração", "pc":{"r":370,"t":195},"movement":"t"}

        ]
    },
    { "quadrant": "Q4 - Performance, Carga, Segurança e de 'ilidade'",
        "color" : "#B70062",
        "left"  : (w-1000+30),
        "top" :   (h/2 + 18),
        "items" : [
...
//            {"name":"Java 6 and earlier", "pc":{"r":390,"t":350},"movement":"c"}
            ...
            { name: 'Testes de Performance (SUPST)', pc: { r: 60, t: 290 },  movement: 't' },
            { name: 'Teste de Acessibilidade (ASES)', pc: { r: 60, t: 310 },  movement: 't' },
            { name: 'Agendamento de Testes de Performance com Hudson', pc: { r: 60, t: 278 },  movement: 't' },
            { name: 'Testes de Performance (Jmeter)', pc: { r: 150, t: 298 },              movement: 't',  domain: 'template' },
            {"name":"Testes de Acessibilidade", "pc":{"r":130,"t":355},"movement":"t"}
